...
INTELLIGENCE_IR_SECRET_NAME="${INTELLIGENCE_IR_SECRET_NAME:-${SECRET_NAME}}"
INTELLIGENCE_SNS_SECRET_NAME="${INTELLIGENCE_SNS_SECRET_NAME:-${SECRET_NAME}}"
...
補足:
  ...
  - IR/SNS通知を分離する場合は INTELLIGENCE_IR_SECRET_NAME / INTELLIGENCE_SNS_SECRET_NAME を指定し、
    DISCORD_WEBHOOK_URL_INTELLIGENCE_IR / DISCORD_WEBHOOK_URL_INTELLIGENCE_SNS で値を渡します。
