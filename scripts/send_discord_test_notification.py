...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Discord webhook URL. Default: {DISCORD_WEBHOOK_DEFAULT_ENV}.",
    )
    parser.add_argument(
        "--message",
...
def main() -> int:
    ...
    if not webhook:
        print(f"Discord webhook URL is required via --webhook-url or {DISCORD_WEBHOOK_DEFAULT_ENV}.", file=sys.stderr)
        return 2
