...
4. Discord/LINEへの配信（Discord先行、LINEはIssue 13で後続）
5. クールダウン（同条件2時間抑制）
...
11. LINE通知方式はMessaging APIを採用し、実装順は `Discord → LINE`（Issue 13継続）
...
5. Discord配信アダプタ
6. LINE配信アダプタ（Issue 13継続: Discord完了後に着手）
7. 欠損通知と運用ログ
