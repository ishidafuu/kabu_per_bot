...
class SignalTest(unittest.TestCase):
    ...
    def test_build_signal_state_streak_increment_on_monday_from_friday(self) -> None:
        medians = MetricMedians(
            ticker="3901:TSE",
    ...
    def test_build_signal_state_resets_when_not_previous_business_day(self) -> None:
        medians = MetricMedians(
            ticker="3901:TSE",
            trade_date="2026-02-13",
            median_1w=11.0,
            ...
            median_1y=13.0,
            source_metric_type=MetricType.PER,
            calculated_at="2026-02-13T00:00:00+00:00",
        )
        current = evaluate_signal(
            ticker="3901:TSE",
            trade_date="2026-02-13",
